...
const styles = StyleSheet.create({
    ...
    readOnlyText: { padding: 10, borderRadius: 5, backgroundColor: '#eee', color: '#555', marginBottom: 10 },
    subtitle: { fontSize: 18, fontWeight: 'bold', marginBottom: 10, color: '#555' },
    categoryItem: { borderWidth: 1, borderColor: '#ccc', padding: 15, borderRadius: 5, marginBottom: 10, backgroundColor: '#fff' },
